...
public class IntArrayList implements RandomAccess, Cloneable, Serializable {
    ...
    public IntArrayList(int[] values, int from, int to) {
    ...
    public void addAll(int[] values, int from, int to) {
    ...
    public void addAll(int index, Collection<Integer> c) {
        if (index < 0 || index > size)
            throw new IndexOutOfBoundsException("Index:" + index + " size:" + size);
    ...
    public void addAll(int index, int[] values, int from, int to) {
     ...
     */
    public boolean removeAll(int[] values, int from, int to) {
        if (from < 0 || from > to || to > values.length)
            throw new IllegalArgumentException();
    ...
    public boolean containsAll(int[] values, int from, int to) {
        if (from < 0 || from > to || to > values.length)
            throw new IllegalArgumentException();
    ...
    public IntArrayList clone() {
        return new IntArrayList(buffer, 0, size);
    }
